...
class MainActivity : AppCompatActivity() {
    ...
    private fun configureSdk(authenticatedToken: String? = "", sourceId: String? = "") {
        ...
        Log.e(
            "interfaceData",
            selectedTheme.toString() + "language" + selectedLanguage.toString() + "cardedge " + selectedCardEdge.toString() + " loader" + loader.toString() + "selectedColorStylee " + selectedColorStylee.toString()
        )
        ...
        Log.e(
            "scope",
            "scope is : " + scopeKey.toString() + " transactionRefrenceKey : " + " " + transactionRefrenceKey.toString() + " transactionAuthroizeTypeKey : " + transactionAuthroizeTypeKey.toString() + " transactionAuthroizeTimeKey : " + transactionAuthroizeTimeKey.toString()
        )
        ...
        val supportedPaymentAuthentications =
            intent.getStringArrayExtra("supportedPaymentAuthenticationsKey")
        val supportedSchemes = intent.getStringArrayExtra("supportedSchemesKey")
        Log.e(
            "acceptance",
            "suppored fund is : " + supportedFund.toString() + " supportedPaymentAuthentications : " + " " + supportedPaymentAuthentications.toString() + " supportedSchemes : " + supportedSchemes.toString()
        )
...
//        })
        ...
        when (PayButtonType.valueOf(buttonKey.toString())) {
            PayButtonType.VISA, PayButtonType.AMERICANEXPRESS, PayButtonType.MASTERCARD, PayButtonType.MADA -> findViewById<TextView>(
                R.id.auth_token
        ...
        findViewById<PayButton>(R.id.paybutton).initPayButton(this, configuration,
            PayButtonType.valueOf(buttonKey.toString()), object : PayButtonStatusDelegate {
                ...
                override fun onChargeCreated(data: String) {
                    Toast.makeText(this@MainActivity, "charge created $data", Toast.LENGTH_SHORT)
                        .show()
                ...
                override fun onOrderCreated(data: String) {
                    Toast.makeText(this@MainActivity, "order created $data", Toast.LENGTH_SHORT)
                        .show()
                }
